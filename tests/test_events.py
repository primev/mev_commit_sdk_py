...
class TestHypersyncEvents(unittest.TestCase):
    ...
    def test_l1_blocks(self):
        l1_blocks = asyncio.run(self.client.get_new_l1_block_event())
    ...
    def test_window_deposits(self):
        window_deposits = asyncio.run(self.client.get_window_deposits())
    ...
    def test_window_withdrawals(self):
        window_withdrawals = asyncio.run(self.client.get_window_withdraws())
    ...
    def test_commit_stores(self):
        commit_stores = asyncio.run(self.client.get_commit_stores())
    ...
    def test_encrypted_stores(self):
        encrypted_stores = asyncio.run(
            self.client.get_encrypted_commit_stores())
    ...
    def test_commits_processed(self):
        commits_processed = asyncio.run(self.client.get_commits_processed())
    ...
    def test_funds_retrieved(self):
        funds_retrieved = asyncio.run(self.client.get_funds_retrieved())
    ...
    def test_funds_rewarded(self):
        funds_rewarded = asyncio.run(self.client.get_funds_rewarded())
    ...
    def test_funds_slashed(self):
        funds_slashed = asyncio.run(self.client.get_funds_slashed())
